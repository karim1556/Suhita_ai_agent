...
export const PlaygroundTile: React.FC<PlaygroundTileProps> = ({
  ...
  return (
    <div
      className={`flex flex-col border rounded-xl border-gray-800 text-gray-500 bg-${backgroundColor} ${className}`}
    >
      {title && (
        <div
          className="flex items-center justify-center text-xs uppercase py-3 border-b border-b-gray-800 tracking-wider"
...
export const PlaygroundTabbedTile: React.FC<PlaygroundTabbedTileProps> = ({
  ...
  return (
    <div
      className={`flex flex-col h-full border rounded-xl border-gray-800 text-gray-500 bg-${backgroundColor} ${className}`}
    >
      <div
